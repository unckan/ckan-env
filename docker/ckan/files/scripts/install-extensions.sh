...
pip install -e git+https://github.com/unckan/ckanext-citeproc.git@v1.0.0#egg=ckanext-citeproc
pip install -r https://raw.githubusercontent.com/unckan/ckanext-citeproc/refs/tags/v1.0.0/requirements.txt
