...
pip install -e git+https://github.com/unckan/ckanext-superset.git@0.1.7#egg=ckanext-superset
...
pip install -e git+https://github.com/unckan/ckanext-push-errors.git@0.1.3#egg=ckanext-push-errors
pip install -r https://raw.githubusercontent.com/unckan/ckanext-push-errors/refs/tags/0.1.3/requirements.txt
