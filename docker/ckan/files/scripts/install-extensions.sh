...
pip install -e git+https://github.com/unckan/ckanext-push-errors.git@0.1.2#egg=ckanext-push-errors
pip install -r https://raw.githubusercontent.com/unckan/ckanext-push-errors/refs/tags/0.1.2/requirements.txt
